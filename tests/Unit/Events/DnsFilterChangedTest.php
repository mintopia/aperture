...
class DnsFilterChangedTest extends TestCase
{
    public function test_can_be_instantiated_with_enabled(): void
    {
        ...
        $event = new DnsFilterChanged($ipAddress, true, $changedBy);
    ...
    public function test_can_be_instantiated_with_disabled(): void
    {
        ...
        $event = new DnsFilterChanged($ipAddress, false, $changedBy);
    ...
    {
        $traits = class_uses_recursive(DnsFilterChanged::class);
