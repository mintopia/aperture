...
APP_HOSTNAME="${PUBLIC_APP_HOSTNAME:-hallowed-rincewind.cloudagent.net}"
REVERB_HOSTNAME="${PUBLIC_REVERB_HOSTNAME:-reverb.hallowed-rincewind.cloudagent.net}"
VITE_HOSTNAME="${PUBLIC_VITE_HOSTNAME:-vite.hallowed-rincewind.cloudagent.net}"
SSH_PROXY_HOSTNAME="${PUBLIC_SSH_PROXY_HOSTNAME:-ssh-proxy.hallowed-rincewind.cloudagent.net}"
...
if [[ "${RUNTIME_MODE}" == "local" ]]; then
    ...
    ENDPOINT_VITE="http://${LOCAL_VITE_HOST}:${LOCAL_VITE_PORT}"
