...
Handover should be brief, conveying only neccessary information and not verbose.
...
If problems were encountered, eg. code review, linting, tests, they are added to the appropriate severity array in the problems object.
...
### PHP
  ...
  - RectorPHP muse be used with a Laravel ruleset
  - PHPUnit for Tests
...
### User Interface
  - Playwright and the Playright CLI/MCP can be used
