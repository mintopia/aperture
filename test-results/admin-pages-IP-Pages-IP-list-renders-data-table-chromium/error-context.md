...
- Name: admin-pages.spec.js >> IP Pages >> IP list renders data table
- Location: tests/e2e/admin-pages.spec.js:4:5
...
Expected substring: "IP Addresses"
Timeout: 5000ms
