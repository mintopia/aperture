...
- Name: admin-pages.spec.js >> IP Pages >> IP list has search inputs
- Location: tests/e2e/admin-pages.spec.js:10:5
...
Locator: getByTestId('search-address')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('search-address')
