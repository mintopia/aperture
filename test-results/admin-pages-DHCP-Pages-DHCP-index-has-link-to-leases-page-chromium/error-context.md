...
- Name: admin-pages.spec.js >> DHCP Pages >> DHCP index has link to leases page
- Location: tests/e2e/admin-pages.spec.js:87:5
...
Call log:
  ...
  - waiting for locator('a[href*="leases"]')
