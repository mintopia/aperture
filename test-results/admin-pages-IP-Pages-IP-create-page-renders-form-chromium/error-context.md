...
- Name: admin-pages.spec.js >> IP Pages >> IP create page renders form
- Location: tests/e2e/admin-pages.spec.js:30:5
...
Expected substring: "Add IP Address"
Timeout: 5000ms
