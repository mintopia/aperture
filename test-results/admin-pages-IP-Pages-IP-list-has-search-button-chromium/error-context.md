...
- Name: admin-pages.spec.js >> IP Pages >> IP list has search button
- Location: tests/e2e/admin-pages.spec.js:16:5
...
Locator: getByTestId('action-search')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('action-search')
