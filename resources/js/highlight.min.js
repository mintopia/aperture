...
var hljs = (function () {
    ...
    function Q(e) {
        ...
        class a {
            ...
            exec(e) {
                ...
                return (
                    t && ((this.regexIndex += t.position + 1), this.regexIndex === this.count && this.considerAll()),
                    t
                );
            }
        }
            ...
            function c() {
                ...
                for (; n; ) {
                    ...
                    if (r) {
                        const [e, a] = r;
                        if (
                            (M.addText(t), (t = ''), (l[i] = (l[i] || 0) + 1), l[i] <= 7 && (A += a), e.startsWith('_'))
                        )
                            t += n[0];
                        else {
                ...
                if (((h = r), 'begin' === r.type))
                    return ((e) => {
                        ...
                        return (
                            a.skip
                                ? (S += n)
                                : (a.excludeBegin && (S += n), g(), a.returnBegin || a.excludeBegin || (S = n)),
                            b(a, e),
        ...
        function y(e) {
            ...
            const t = ((e) => {
                ...
                if (t) {
                    const n = v(t[1]);
                    return (
                        n || (H(o.replace('{}', t[1])), H('Falling back to no-highlight mode for this block.', e)),
                        n ? t[1] : 'no-highlight'
                    );
                }
    ...
    function we(e) {
        const n = e.regex,
            ...
            c = {
                ...
                starts: { end: '`', returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, l], subLanguage: 'xml' },
            },
            d = {
                begin: 'css`',
                end: '',
    ...
    var Ue = Object.freeze({
        ...
        grmr_c: (e) => {
            const n = e.regex,
                ...
                b = {
                    ...
                    keywords: g,
                    contains: u.concat([
                        { begin: /\(/, end: /\)/, keywords: g, contains: u.concat(['self']), relevance: 0 },
                    ]),
                    relevance: 0,
                },
                m = {
        ...
        grmr_cpp: (e) => {
            const n = e.regex,
                ...
                m = {
                    ...
                    keywords: g,
                    contains: b.concat([
                        { begin: /\(/, end: /\)/, keywords: g, contains: b.concat(['self']), relevance: 0 },
                    ]),
                    relevance: 0,
                },
                p = {
        ...
        grmr_kotlin: (e) => {
            ...
            const s = {
                ...
                o = {
                    className: 'meta',
                    begin: '@' + e.UNDERSCORE_IDENT_RE,
                    contains: [{ begin: /\(/, end: /\)/, contains: [e.inherit(r, { className: 'string' }), 'self'] }],
                },
                l = ge,
        ...
        grmr_less: (e) => {
                ...
                u = {
                    ...
                    contains: [
                        ...
                        n.CSS_VARIABLE,
                        {
                            ...
                            starts: { endsWithParent: !0, illegal: '[<=$]', relevance: 0, contains: r },
                        },
                    ],
                },
                b = {
            ...
            return (
                i.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, b, m, _, u, p, g, n.FUNCTION_DISPATCH),
                ...
                x = [
                    {
                        match: /(@|#(un)?)available/,
                        className: 'keyword',
                        starts: { contains: [{ begin: /\(/, end: /\)/, keywords: Fe, contains: [...b, h, v] }] },
                    },
