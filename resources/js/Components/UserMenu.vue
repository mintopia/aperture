...
<template>
    <div ref="menuRef" class="relative">
        ...
        <div
            ...
            class="absolute right-0 top-full z-50 mt-2 w-52 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] py-1 shadow-lg"
        >
            <!-- Dashboard -->
            <Link
                :href="route('home')"
            ...
            <Link
                ...
                class="flex items-center gap-2.5 px-4 py-2 text-sm text-[var(--color-danger)] transition-colors hover:bg-[var(--color-surface-hover)]"
                @click="open = false"
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4 shrink-0">
