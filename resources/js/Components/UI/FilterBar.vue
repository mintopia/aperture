    ...
    <div data-testid="filter-bar" class="mb-5 flex flex-wrap items-center gap-2.5">
        <div data-testid="filter-search" class="relative max-w-[320px] min-w-[200px] flex-1">
            ...
            <input
                ...
                class="w-full rounded border border-[var(--color-border-hover)] bg-[var(--color-surface)] py-2 pr-3 pl-8 text-[13px] text-[var(--color-text)] transition-[border-color] duration-150 placeholder:text-[var(--color-text-muted)] focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)] focus:outline-none focus:ring-inset"
