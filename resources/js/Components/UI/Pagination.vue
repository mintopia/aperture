...
<template>
    <div v-if="paginator.last_page > 1" data-testid="pagination" class="flex flex-wrap items-center justify-between gap-4 border-t border-[var(--color-border)] pt-3 text-sm">
