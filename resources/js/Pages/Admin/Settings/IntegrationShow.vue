        ...
        >
            ...
            >
                ...
                <template v-if="testResult.response_status">
                    &middot; Status
                    <span :class="testResult.success ? 'text-[var(--color-success)]' : 'text-[var(--color-danger)]'">
                    ...
                    <tbody>
                        ...
                        >
                            <td class="px-4 py-3">
                                <span class="inline-flex items-center gap-1.5">
                                    ...
                                    <span
                                        ...
                                        :class="
                                            log.success ? 'text-[var(--color-success)]' : 'text-[var(--color-danger)]'
                                        "
                                    >
                            ...
                            <td class="px-4 py-3 font-mono text-xs text-[var(--color-text-secondary)]">
                                <span v-if="log.request_method">{{ log.request_method }} {{ log.request_url }}</span>
